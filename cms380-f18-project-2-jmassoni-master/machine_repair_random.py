    ...
    while time < max_time and not queue.empty():
        ...
        if type == 'breakdown':
            ...
            if chosenQueue == 1:
                ...
                print '@', time, 'minutes Machine', machine, 'had a', type, 'and was sent to Queue', chosenQueue, repair_queue1
                
            else:
                
                print '@', time, 'minutes Machine', machine, 'had a', type, 'and was sent to Queue', chosenQueue, repair_queue2
        ...
        # Process repair events
            ...
            if chosenQueue == 1:
                ...
                print '@', time, 'minutes Machine', machine, 'went in for', type, 'in Queue', chosenQueue, repair_queue1
                
            else:
                
                print '@', time, 'minutes Machine', machine, 'went in for', type, 'in Queue', chosenQueue, repair_queue2
